...
// Timer functions.
//
#ifndef __UTILS_TIMERS_H_
#define __UTILS_TIMERS_H_
...
typedef long long microsec_t;       // 1/1000000 second
typedef long long millisec_t;       // 1/1000 second
extern long long systemMonoTime();	// unit is 1/1000000000 second.


static inline millisec_t milliSystemTime()
{
	return systemMonoTime() / 1000000LL;
}



static inline microsec_t microSystemTime()
{
	return systemMonoTime() / 1000LL;
}
